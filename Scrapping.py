...
# Base de l'URL de pagination
base_url = "https://www.mubawab.tn/fr/ct/tunis/immobilier-a-vendre:p:{}"
...
for page in range(1, total_pages + 1):
    ...
    # Sélectionner les annonces (ajoute plusieurs classes si nécessaire)
